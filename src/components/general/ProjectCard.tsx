    ...
    <article className="h-[319px] md:h-[531px] w-full p-[5px] rounded-[20px] md:rounded-[32px] border border-[#ffffff9e] backdrop-blur-[26.32px] shadow-[2px_3px_40.3px_-10px_#FFFFFFBF]">
      <div className="relative w-full h-full">
        <img
          src={WishWeaver}
          alt="WishWeaver"
          className="w-full h-full object-cover rounded-[16px] md:rounded-[28px]"
        />
        <div className="absolute bottom-0 left-0 w-full bg-white rounded-[20px] md:p-6 p-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <a
              href="#"
              className="group flex items-center gap-2 text-[#A4A4A4] hover:text-gray-400 transition-colors text-xs font-normal bg-[#F6F5F6] rounded-[100px] py-2 px-3"
            >
              View site
